...
const SUPPLIERS = [
  {
    name: 'Deccan Pharma Distributors',
    phone: '02026551234',
    email: 'orders@deccanpharma.example',
    gstin: '27AABCD1234E1Z5',
    addressLine: 'Shop 14, Market Yard, Pune 411037',
  },
  {
    name: 'Sahyadri Medico Agencies',
    phone: '02024449876',
    email: 'sales@sahyadrimedico.example',
    gstin: '27AACCS5678F1Z2',
    addressLine: 'Plot 8, MIDC Bhosari, Pune 411026',
  },
  {
    name: 'Gujarat Health Supplies',
    phone: '07926781234',
    email: 'contact@gujhealth.example',
    gstin: '24AAGCG9012K1Z9',
    addressLine: 'Nr. Gurukul Road, Ahmedabad 380052',
  },
  {
    name: 'Bharat Surgicals',
    phone: '08028776543',
    email: 'info@bharatsurgicals.example',
    gstin: '29AABCB3456L1Z4',
    addressLine: 'Jayanagar 4th Block, Bengaluru 560011',
  },
  {
    name: 'Nova Life Sciences',
    phone: '02228990011',
    email: 'support@novalifesciences.example',
    gstin: '27AAECN7788M1Z1',
    addressLine: 'Andheri East, Mumbai 400069',
  },
];
...
const DRUGS = [
    ...
    batches: [
      {
        ...
        quantity: 480,
        costPricePaise: 120,
        supplier: 'Deccan Pharma Distributors',
      },
      {
        batchNo: 'PCM-2588',
  ...
  },
  {
    ...
    batches: [
      {
        batchNo: 'AMX-2602',
        expiryDate: EXPIRY_FURTHER,
        quantity: 300,
        costPricePaise: 820,
        supplier: 'Sahyadri Medico Agencies',
      },
    ],
  },
  {
    ...
    batches: [
      {
        ...
        quantity: 200,
        costPricePaise: 1100,
        supplier: 'Gujarat Health Supplies',
      },
    ],
  },
  {
...
const CHILD_VACCINES = [
  ...
  },
  {
    ...
    dateGiven: '2020-04-22',
    doseLabel: 'Dose 1',
  },
  {
    vaccineCode: 'DPT',
    vaccineName: 'DPT Booster',
    dateGiven: '2021-01-18',
    doseLabel: 'Booster 1',
  },
];
  ...
  tenants: [
    ...
    // -----------------------------------------------------------------------
    {
      ...
      users: [
        ...
        {
          email: 'former.staff@citycare.example',
          fullName: 'Vikas Bhosale',
          role: 'receptionist',
          status: 'inactive',
        },
      ],
      providers: [
        ...
        {
          fullName: 'Dr. Neelam Kulkarni',
          qualification: 'MBBS, DCH',
          registrationNumber: 'MMC-2016-20194',
          specialty: 'pediatrics',
          userEmail: 'doctor2@citycare.example',
        ...
        },
        {
          ...
          registrationNumber: 'MMC-2013-08877',
          specialty: 'orthopedics',
          userEmail: 'doctor3@citycare.example',
          consultationFeePaise: 70000,
          schedule: CLINIC_ROSTER,
        },
        // No roster — free-form booking is still supported and needs a doctor who shows it.
        {
          ...
          registrationNumber: 'MMC-2018-30455',
          specialty: 'dermatology',
          consultationFeePaise: 60000,
        },
        // Retired consultant: inactive, so they cannot be booked but their history remains.
        {
          fullName: 'Dr. Mohan Kelkar',
          qualification: 'MBBS, MD',
          registrationNumber: 'MMC-1998-00312',
          specialty: 'general_medicine',
      ...
      patients: [
        {
          ...
          bloodGroup: 'B+',
          addressLine: 'Flat 302, Sunshine Residency, Karve Nagar',
          city: 'Pune',
          state: 'Maharashtra',
          pincode: '411052',
          emergencyContactName: 'Sneha Kulkarni',
          emergencyContactPhone: '9820011235',
        },
        {
          firstName: 'Isha',
          lastName: 'Deshpande',
          ...
          phone: '9822045678',
          email: 'isha.deshpande@example.com',
          bloodGroup: 'O+',
          addressLine: '14, Prabhat Road Lane 6',
          city: 'Pune',
          state: 'Maharashtra',
          pincode: '411004',
        },
        {
          ...
          phone: '9821099887',
          bloodGroup: 'A+',
          addressLine: 'Row House 7, Sus Road',
          city: 'Pune',
          state: 'Maharashtra',
          pincode: '411021',
          emergencyContactName: 'Rohit Patil',
          emergencyContactPhone: '9821099888',
          immunizations: CHILD_VACCINES,
        },
        {
          firstName: 'Meera',
          lastName: 'Joshi',
          ...
          phone: '9823310022',
          bloodGroup: 'AB+',
          addressLine: 'Bungalow 5, Model Colony',
          city: 'Pune',
          state: 'Maharashtra',
          pincode: '411016',
        },
        ...
        },
        {
          ...
          phone: '9890220198',
          bloodGroup: 'O+',
          addressLine: 'Lane 3, Kalyani Nagar',
          city: 'Pune',
          state: 'Maharashtra',
          pincode: '411006',
        },
        ...
        },
        {
          ...
          lastName: 'Naik',
          gender: 'male',
          dateOfBirth: '1965-07-02',
          phone: '9860012399',
          bloodGroup: 'A+',
          addressLine: 'Gultekdi',
          city: 'Pune',
          state: 'Maharashtra',
          pincode: '411037',
        },
        ...
        },
        {
          ...
          state: 'Maharashtra',
          pincode: '411058',
          emergencyContactName: 'Prashant Sawant',
          emergencyContactPhone: '9028776612',
          immunizations: CHILD_VACCINES.slice(0, 4),
        },
        {
          firstName: 'Omkar',
          lastName: 'Kadam',
        ...
        },
        {
          ...
          phone: '7020118899',
          email: 'priyanka.dhole@example.com',
          bloodGroup: 'O-',
          addressLine: 'Viman Nagar',
          city: 'Pune',
          state: 'Maharashtra',
          pincode: '411014',
        },
        ...
        },
        {
          ...
          phone: '7385220099',
          bloodGroup: 'O+',
          addressLine: 'Chinchwad Station Road',
          city: 'Pimpri-Chinchwad',
          state: 'Maharashtra',
          pincode: '411019',
        },
        ...
        },
        {
          ...
          phone: '9767334455',
          bloodGroup: 'O+',
          addressLine: 'Yerawada',
          city: 'Pune',
          state: 'Maharashtra',
          pincode: '411006',
          immunizations: CHILD_VACCINES.slice(0, 5),
        },
        {
          firstName: 'Ishaan',
          lastName: 'Kamat',
        ...
        },
        {
          ...
          lastName: 'Chaudhari',
          gender: 'male',
          dateOfBirth: '1976-11-22',
          phone: '9130778899',
          bloodGroup: 'B+',
          addressLine: 'Wanowrie',
          city: 'Pune',
          state: 'Maharashtra',
          pincode: '411040',
        },
      ...
      registrationRequests: [
        {
          ...
          phone: '9145220033',
          city: 'Pune',
          note: 'Scanned the QR at the reception desk',
          decision: 'pending',
        },
        {
          firstName: 'Vaishali',
        ...
        },
        {
          ...
          phone: '9145880099',
          city: 'Pimpri-Chinchwad',
          note: 'Wants an appointment with Orthopaedics',
          decision: 'pending',
        },
        {
          firstName: 'Sarika',
        ...
        },
        {
          ...
          phone: '9000000000',
          city: 'Pune',
          note: 'Obvious junk submission',
          decision: 'rejected',
          rejectionReason: 'Not a genuine registration',
        },
        {
          firstName: 'Anjali',
          lastName: 'Kamble',
      ...
      bookingRequests: [
        ...
        },
        {
          ...
          lastName: 'Merchant',
          phone: '9147440022',
          note: 'Follow-up for blood pressure',
          decision: 'pending',
        },
        ...
        },
        {
          ...
          phone: '9148550077',
          decision: 'rejected',
          rejectionReason: 'Requested department is not available at this branch',
        },
      ],
    ...
    // -----------------------------------------------------------------------
    {
      ...
      providers: [
        ...
        {
          fullName: 'Dr. Hetal Bhatt',
          qualification: 'MBBS, DGO',
          registrationNumber: 'GMC-2015-14200',
          specialty: 'gynecology',
          userEmail: 'doctor2@sunrise.example',
          consultationFeePaise: 55000,
          schedule: CLINIC_ROSTER,
        },
        {
          fullName: 'Dr. Priya Patel',
          qualification: 'MBBS, MD (Pathology)',
          registrationNumber: 'GMC-2009-03311',
          specialty: 'general_medicine',
          userEmail: 'admin@sunrise.example',
          consultationFeePaise: 40000,
        },
      ],
      labTests: LAB_TESTS,
      ...
      patients: [
        {
          ...
          phone: '9898012345',
          email: 'rajesh.chaudhary@example.com',
          bloodGroup: 'A+',
          addressLine: '12, Prernatirth Derasar Road',
          city: 'Ahmedabad',
          state: 'Gujarat',
          pincode: '380015',
        },
        ...
        },
        {
          ...
          lastName: 'Trivedi',
          gender: 'male',
          dateOfBirth: '1969-11-09',
          phone: '9825110022',
          bloodGroup: 'O+',
          addressLine: 'Maninagar East',
          city: 'Ahmedabad',
          state: 'Gujarat',
          pincode: '380008',
        },
        {
          ...
          phone: '9825440033',
          email: 'nandini.vyas@example.com',
          bloodGroup: 'B+',
        ...
        },
        {
          ...
          phone: '9377440055',
          email: 'zeel.kothari@example.com',
          bloodGroup: 'O+',
          addressLine: 'Bopal',
          city: 'Ahmedabad',
          state: 'Gujarat',
      ...
      bookingRequests: [
        ...
        { firstName: 'Nita', lastName: 'Vaghela', phone: '9558991133', decision: 'approved' },
        {
          ...
          phone: '9000000002',
          decision: 'rejected',
          rejectionReason: 'Number not reachable',
        },
      ],
    ...
    // -----------------------------------------------------------------------
    {
      ...
      providers: [
        {
          fullName: 'Dr. Latha Srinivas',
          qualification: 'MBBS, DNB (Family Medicine)',
          registrationNumber: 'KMC-2010-05512',
          specialty: 'general_medicine',
          userEmail: 'admin@lotus.example',
          consultationFeePaise: 40000,
          schedule: CLINIC_ROSTER,
        },
        {
          fullName: 'Dr. Girish Rao',
          qualification: 'MBBS, DCH',
          registrationNumber: 'KMC-2017-22190',
          specialty: 'pediatrics',
          userEmail: 'doctor@lotus.example',
      ...
      patients: [
        ...
        },
        {
          ...
          lastName: 'Murthy',
          gender: 'male',
          dateOfBirth: '1959-08-08',
          phone: '9845880088',
          bloodGroup: 'O+',
          addressLine: 'Malleshwaram',
          city: 'Bengaluru',
          state: 'Karnataka',
          pincode: '560003',
        },
      ...
      bookingRequests: [
        ...
        { firstName: 'Srinivas', lastName: 'Rao', phone: '9846990099', decision: 'approved' },
        {
          ...
          phone: '9846770077',
          decision: 'rejected',
          rejectionReason: 'Requested a service the clinic does not offer',
        },
      ],
    ...
    // -----------------------------------------------------------------------
    {
      ...
      providers: [
        {
          fullName: 'Dr. Sameera Qureshi',
          qualification: 'MBBS',
          registrationNumber: 'MPMC-2019-40011',
          specialty: 'general_medicine',
          userEmail: 'admin@greenleaf.example',
...
async function main(): Promise<void> {
  ...
  console.log(
    '  Portal   CITYCARE / admin@citycare.example      (busy hospital — every module on)',
  );
  console.log(
    '  Portal   SUNRISE  / admin@sunrise.example       (second tenant — isolation checks)',
  );
