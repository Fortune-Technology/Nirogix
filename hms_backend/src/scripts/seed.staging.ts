  ...
  tenants: [
    ...
    },
    {
      ...
      providers: [
        ...
        {
          fullName: 'Dr QA Cardiologist',
          qualification: 'MBBS, DM (Cardiology)',
          registrationNumber: 'QA-REG-0002',
          specialty: 'cardiology',
          userEmail: 'qa.doctor2@qahospital.example',
          consultationFeePaise: 80000,
          schedule: QA_ROSTER,
        },
        // No roster: free-form booking has to stay testable alongside the roster rule.
        {
          fullName: 'Dr QA Paediatrician',
          qualification: 'MBBS, DCH',
          registrationNumber: 'QA-REG-0003',
          specialty: 'pediatrics',
          consultationFeePaise: 45000,
        },
        // Inactive: cannot be booked, but their past records must still render.
        {
          fullName: 'Dr QA Retired',
          qualification: 'MBBS',
          registrationNumber: 'QA-REG-0004',
          specialty: 'general_medicine',
      ...
      suppliers: [
        {
          name: 'QA Pharma Distributors',
          phone: '07911110000',
          email: 'qa.supplier1@example.com',
          gstin: '24AAQCS0001S1Z1',
          addressLine: 'QA Industrial Estate, Ahmedabad 382210',
        },
        {
          name: 'QA Surgical Supplies',
          phone: '07922220000',
          email: 'qa.supplier2@example.com',
          gstin: '24AAQCS0002S1Z2',
          addressLine: 'QA Trade Centre, Ahmedabad 380054',
        },
        {
          name: 'QA Cold Chain Agencies',
          phone: '07933330000',
          email: 'qa.supplier3@example.com',
          gstin: '24AAQCS0003S1Z3',
          addressLine: 'QA Logistics Park, Ahmedabad 382330',
        },
      ],
      drugs: [
        {
          ...
          batches: [
            {
              batchNo: 'QA-PCM-01',
              expiryDate: EXPIRY_FAR,
              quantity: 400,
              costPricePaise: 120,
              supplier: 'QA Pharma Distributors',
            },
            {
              batchNo: 'QA-PCM-02',
          ...
          batches: [
            {
              ...
              quantity: 260,
              costPricePaise: 500,
              supplier: 'QA Surgical Supplies',
            },
          ],
        },
        {
          name: 'ORS Sachet 21 g',
          form: 'sachet',
          strength: '21 g',
          unit: 'sachet',
          hsnSac: '3004',
          ...
          batches: [
            {
              ...
              quantity: 150,
              costPricePaise: 1100,
              supplier: 'QA Cold Chain Agencies',
            },
          ],
        },
        {
      ...
      patients: [
        {
          firstName: 'QA Patient',
          lastName: 'One',
          gender: 'female',
          dateOfBirth: '1990-01-01',
          phone: '+919000000001',
          email: 'qa.patient.one@example.com',
          bloodGroup: 'O+',
          addressLine: '1 QA Street',
          city: 'Ahmedabad',
          state: 'Gujarat',
          pincode: '380015',
        },
        ...
        },
        {
          ...
          phone: '+919000000303',
          email: 'alpa.trivedi@example.com',
          bloodGroup: 'O+',
          addressLine: 'Chandkheda',
          city: 'Ahmedabad',
          state: 'Gujarat',
          pincode: '382424',
        },
        ...
        },
        {
          ...
          phone: '+919000000309',
          email: 'vaishali.gohel@example.com',
          bloodGroup: 'AB-',
      ...
      registrationRequests: [
        {
          firstName: 'QA Walkin',
          lastName: 'Pending One',
          gender: 'female',
          dateOfBirth: '1994-04-04',
          phone: '+919000001001',
          city: 'Ahmedabad',
          note: 'Submitted from the QR poster',
          decision: 'pending',
        },
        {
          firstName: 'QA Walkin',
          lastName: 'Pending Two',
          gender: 'male',
        ...
        {
          firstName: 'QA Walkin',
          lastName: 'Rejected One',
          gender: 'male',
          phone: '+919000001006',
          city: 'Ahmedabad',
          decision: 'rejected',
          rejectionReason: 'Incomplete details on the form',
        },
        {
          firstName: 'QA Walkin',
          lastName: 'Rejected Two',
          gender: 'female',
          phone: '+919000001007',
          city: 'Ahmedabad',
          decision: 'rejected',
          rejectionReason: 'Duplicate of an existing chart',
        },
      ],
      bookingRequests: [
        {
        ...
        },
        {
          ...
          phone: '+919000002006',
          decision: 'rejected',
          rejectionReason: 'No slot available on the requested day',
        },
        {
          firstName: 'QA Booking',
          lastName: 'Rejected Two',
          phone: '+919000002007',
          decision: 'rejected',
          rejectionReason: 'Could not be reached to confirm',
        },
      ],
    ...
    // ---------------------------------------------------------------------------------------
    {
      ...
      users: [
        ...
        {
          email: 'qc.reception@qaclinic.example',
          fullName: 'QC Receptionist',
          role: 'receptionist',
        },
      ...
      providers: [
        {
          fullName: 'Dr QC Physician',
          qualification: 'MBBS, MD',
          registrationNumber: 'QC-REG-0001',
          specialty: 'general_medicine',
          userEmail: 'qc.doctor@qaclinic.example',
          consultationFeePaise: 40000,
          schedule: QA_ROSTER,
        },
        {
          fullName: 'Dr QC Paediatrician',
          qualification: 'MBBS, DCH',
          registrationNumber: 'QC-REG-0002',
          specialty: 'pediatrics',
          consultationFeePaise: 35000,
        },
      ],
      services: [
        {
      ...
      patients: [
        ...
        },
        {
          ...
          phone: '+919000000402',
          email: 'asmita.raval@example.com',
          bloodGroup: 'O+',
          addressLine: 'Satellite',
          city: 'Ahmedabad',
          state: 'Gujarat',
          pincode: '380015',
        },
      ...
      bookingRequests: [
        ...
        },
        {
          ...
          phone: '+919000002104',
          decision: 'rejected',
          rejectionReason: 'The clinic does not offer that service',
        },
      ],
    ...
    // ---------------------------------------------------------------------------------------
    {
      ...
      users: [
        ...
        {
          email: 'qr.reception@qaretired.example',
          fullName: 'QR Receptionist',
          role: 'receptionist',
        },
      ],
      providers: [
        {
          fullName: 'Dr QR Physician',
          qualification: 'MBBS',
          registrationNumber: 'QR-REG-0001',
          specialty: 'general_medicine',
          userEmail: 'qr.admin@qaretired.example',
          consultationFeePaise: 30000,
        },
      ],
      patients: [
        {
          firstName: 'QA Retired',
...
async function main(): Promise<void> {
  ...
  console.log(
    '  Admin   NIROGIX  / the operator accounts — their real staging passwords are not in this repo.',
  );
