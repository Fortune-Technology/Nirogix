...
// A random, human-handoff temporary password (returned once), generated by the one policy
// every password on the platform is held to (ADR-082) — the org admin changes it on first login.
import { generateTempPassword } from '../auth/passwordPolicy';
