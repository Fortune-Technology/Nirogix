...
function ServicesTable() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setError(err instanceof api.ApiRequestError ? err.message : "Failed to load the services catalogue.");
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  async function submitForm(e: FormEvent) {
    ...
    try {
      ...
      setFormError(err instanceof api.ApiRequestError ? err.message : "Could not save the service.");
    } finally {
      setSavingForm(false);
    }
  }
  ...
  const columns: Array<Column<Service>> = [
    ...
    },
    {
      ...
      cell: (s) => (s.isActive ? <Badge tone="success">Active</Badge> : <Badge tone="danger">Inactive</Badge>),
    },
  ...
  return (
    <>
      ...
      <Dialog
        ...
        description={editing ? undefined : "Adds a priced item to the catalogue. New bills pick it up immediately."}
        size="lg"
        busy={savingForm}
        footer={
