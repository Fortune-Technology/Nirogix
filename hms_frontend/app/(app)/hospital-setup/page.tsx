...
const AREAS: Area[] = [
  {
    ...
    label: 'Branches',
    blurb:
      'The locations your hospital runs. Staff, providers and records are organised under them.',
    icon: GitBranch,
  ...
  },
  {
    ...
    label: 'Departments',
    blurb:
      'The clinical departments patients are seen in. Doctors belong to them and check-in routes by them.',
    icon: Network,
  ...
  },
  {
    ...
    blurb:
      'List this hospital in the Health Facility Registry and its clinicians in the Professional Registry.',
    icon: Landmark,
    ...
    <RequirePermission perm={PERMISSIONS.ORG_PROFILE_MANAGE}>
      ...
      <Card header="Configuration areas">
        <p className="mb-4 text-sm text-fg-muted">
          Each area has its own screen, reachable from here or from the sidebar. Setup is never the
          only way in. Everything below can be changed at any time.
        </p>
