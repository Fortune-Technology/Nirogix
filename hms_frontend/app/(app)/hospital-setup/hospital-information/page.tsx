...
const FIELDS: ProfileField[] = [
  ...
  },
  {
    ...
    hint: 'What patients see. Defaults to the name above.',
    wide: true,
  },
  ...
  { key: 'phone', label: 'Phone' },
  {
    ...
    hint: 'Reception, emergency or a second line.',
  },
  ...
  { key: 'website', label: 'Website', hint: 'Include https://' },
  {
    ...
    hint: 'Clinical establishment / hospital registration.',
  },
  ...
  return (
    <Card header="Hospital">
      ...
      <p className="mt-2 text-sm text-fg-muted">
        Your hospital&apos;s name and code were set when Nirogix created your account. Talk to us to
        change them. Everything below is yours to maintain, and appears in the header of every
        invoice and report you print.
      </p>
    </Card>
  );
}
          ...
          <Card header="How this prints">
            {profile.contactLines.length === 0 ? (
              <p className="text-sm text-fg-muted">
                Nothing is configured yet, so your documents print your hospital&apos;s name and
                logo and no address block.
              </p>
            ) : (
