    ...
    <RequirePermission perm={PERMISSIONS.ORG_PROFILE_MANAGE}>
      <Card header="What these three do">
        <p className="text-sm text-fg-muted">
          ...
          off leaves the other two working. <strong className="font-medium text-fg">None of them
          writes to your records.</strong> Every submission waits for a member of staff.
        </p>
        <ul className="mt-3 flex flex-col gap-1 text-sm text-fg-muted">
          ...
          <li>
            <strong className="font-medium text-fg">Self check-in</strong> — a patient says they have
            arrived; your desk checks them in from the{" "}
        ...
        <PublicAccessPanel
          ...
          explainer={
            <>
              ...
              a patient. You stay in control of who is in your records. Requests wait under{" "}
              <Link href="/patients/registrations" className="text-brand hover:underline">
                Patient registrations
              </Link>
              .
        ...
        <PublicAccessPanel
          ...
          explainer={
            <>
              ...
              appointment. <strong className="font-medium text-fg">Nobody is checked in automatically</strong>. Each
              arrival appears on your{" "}
              <Link href="/opd/arrivals" className="text-brand hover:underline">
                Arrivals board
              </Link>
              , where one click checks the patient in against the appointment you already booked — and confirming is
              also the identity check, because your desk can see who is standing there.
            </>
          }
