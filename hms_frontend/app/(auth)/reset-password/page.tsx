...
/**
 * Forgot-password step 2 (ADR-081): the destination of the emailed link
 * (`/reset-password?token=…`). The token is single-use and expires 30 minutes after
 * issue; every failure mode shows the backend's one uniform message. On success every
 * session was revoked server-side, so the only path onward is signing in again.
 */
