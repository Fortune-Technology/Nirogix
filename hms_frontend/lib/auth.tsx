...
// The Portal's session + capabilities context.
//
// On mount it re-establishes the session from the httpOnly refresh cookie, then
// loads the user and their *effective* permission set from the backend. Menu and
// route visibility derive from this set — but visibility is never security: every
// backend endpoint independently re-checks auth → module → permission. The client
// mirror is UX only (resources/memory.md, invariant #2).
