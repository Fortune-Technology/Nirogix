...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      {
        source: '/hospital-setup/patient-registration',
        destination: '/hospital-setup/public-access',
        permanent: true,
      },
      {
        source: '/hospital-setup/online-booking',
        destination: '/hospital-setup/public-access',
        permanent: true,
      },
      {
        source: '/hospital-setup/self-check-in',
        destination: '/hospital-setup/public-access',
        permanent: true,
      },
    ];
