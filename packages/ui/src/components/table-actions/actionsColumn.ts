 ...
 *
 * A module passes only what a row's actions are; the key, header, alignment,
 * width, and the "never sortable, never hideable, always last" behaviour are
 * fixed here so every table's Action column is identical.
 *
