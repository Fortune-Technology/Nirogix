...
describe("disabled and loading", () => {
  it("explains a disabled action through its tooltip instead of failing silently", () => {
    render(<EditAction disabled disabledReason="Signed encounters cannot be edited." onSelect={() => {}} />);
...
describe("toggle", () => {
  it("is a real switch and reports the state the user asked for", () => {
    ...
    render(<ToggleAction on={false} offLabel="Activate branch" onLabel="Deactivate branch" onToggle={onToggle} />);
