// Typed API failures, shared by every Nirogix frontend (ADR-054).
//
// Kept in their own module so the HTTP core and the feedback layer can both use
// them without an import cycle. `ApiRequestError`
