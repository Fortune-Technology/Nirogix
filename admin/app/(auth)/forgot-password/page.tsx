 ...
 * contract as the Portal: the backend answers identically whether or not an account
    ...
    <Card>
      <div className="mb-5 flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-sm text-fg-muted">
          Enter your organization code and operator email, and we&rsquo;ll send a reset link.
        </p>
      </div>
