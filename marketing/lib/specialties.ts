...
export const SPECIALTIES: Specialty[] = [
  {
    ...
    featured: true,
    summary:
      'Follow-up-heavy outpatient care with recurring diagnostics and long patient histories.',
    challenges: [
  ...
  },
  {
    ...
    configuration: [
      'Chair/operatory-wise provider slots',
      'Procedure pricing on the invoice',
      'Multi-visit treatment notes',
    ],
  },
  {
    slug: 'pediatrics',
    ...
    configuration: [
      'Guardian contact on the patient record',
      'Vitals captured per visit',
      'Immunisation and review visit scheduling',
    ],
  },
  {
    slug: 'gynecology',
    ...
    configuration: [
      'Visit scheduling across a long episode',
      'Role-based access to sensitive records',
      'Investigation catalogue and pricing',
    ],
  },
  {
    slug: 'physiotherapy',
    ...
    configuration: [
      'Therapist schedules',
      'Session pricing on the invoice',
      'Session notes per encounter',
    ],
  },
  {
    slug: 'radiology',
    ...
    featured: true,
    summary:
      'Order to report. The diagnostic worklist runs today for labs; the imaging module is planned.',
    challenges: [
    ...
    configuration: [
      'Investigation catalogue and reference ranges',
      'Per-study pricing on the invoice',
      'Worklist roles and permissions',
    ],
  },
  {
    slug: 'psychiatry',
    name: 'Psychiatry',
    icon: Brain,
    summary: 'Confidential long-term records, recurring reviews, and controlled prescribing.',
  },
  {
    slug: 'psychology',
    name: 'Psychology & Counselling',
    icon: Sparkles,
    summary: 'Session-based care with private notes and therapist-owned schedules.',
  },
  {
    slug: 'orthopedics',
    name: 'Orthopedics',
    icon: Bone,
    summary: 'Imaging-led diagnosis, procedures, and structured follow-up.',
  },
  {
    slug: 'dermatology',
    name: 'Dermatology',
    icon: Activity,
    summary: 'High outpatient volume, repeat visits, and procedure billing.',
  },
  {
    slug: 'neurology',
    name: 'Neurology',
    icon: Brain,
    summary: 'Complex histories, diagnostics, and long-running review cycles.',
  },
  {
    slug: 'general-medicine',
    name: 'General Medicine',
    icon: Stethoscope,
    summary: 'The everyday OPD backbone: queue, consult, prescribe, bill.',
  },
  {
    slug: 'general-surgery',
    name: 'General Surgery',
    icon: Scissors,
    summary: 'Pre-op workup, procedure records, and post-op follow-up.',
  },
  {
    slug: 'ophthalmology',
    name: 'Ophthalmology',
    icon: Eye,
    summary: 'Investigation-heavy consults with optical and procedure billing.',
  },
  {
    slug: 'ent',
    name: 'ENT',
    icon: Ear,
    summary: 'Procedure-led outpatient care with day-case workflows.',
  },
  {
    slug: 'urology',
    name: 'Urology',
    icon: Droplets,
    summary: 'Diagnostics, procedures, and structured follow-up scheduling.',
  },
  {
    slug: 'gastroenterology',
    name: 'Gastroenterology',
    icon: Microscope,
    summary: 'Endoscopy scheduling, reports, and per-procedure billing.',
  },
  {
    slug: 'pulmonology',
    name: 'Pulmonology',
    icon: Wind,
    summary: 'Diagnostic-led review cycles and long-term patient tracking.',
  },
  {
    slug: 'oncology',
    name: 'Oncology',
    icon: Ribbon,
    summary: 'Protocol-driven cycles with heavy diagnostics and pharmacy involvement.',
  },
  {
    slug: 'nephrology',
    name: 'Nephrology',
    icon: FlaskConical,
    summary: 'Recurring treatment schedules with continuous lab monitoring.',
  },
  {
    slug: 'endocrinology',
    name: 'Endocrinology',
    icon: Syringe,
    summary: 'Chronic-condition follow-up driven by regular lab results.',
  },
  {
    slug: 'multi-specialty',
    name: 'Multi-specialty hospitals',
    icon: Users,
    summary: 'Several departments on one platform, each configured its own way.',
  },
];
