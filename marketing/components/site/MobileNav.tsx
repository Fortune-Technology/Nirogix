...
export function MarketingMobileNav() {
  ...
  return (
    <div className="lg:hidden">
      <BottomNav linkAs={Link} items={PRIMARY.map((item) => ({ ...item, active: isActive(item.href) }))} />
    </div>
  );
}
...
export function MarketingMenuButton() {
  ...
  return (
    <div className="lg:hidden">
      ...
      <NavDrawer open={open} onClose={() => setOpen(false)} title="Menu" footer={<MarketingMobileActions />}>
